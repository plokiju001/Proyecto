<%-- 
    Document   : PagoMant
    Created on : 30-ene-2017, 11:49:14
    Author     : Azael
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2><b>Pago de mantenimiento.</b></h2>
            
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#ConstruccionGav">Construcciones</a></li>
                <li><a data-toggle="tab" href="#ConstruccionCap">Colocaciones</a></li>
                
            </ul>
            
            <div class="tab-content">
                <form method="post" action="index.html" id="ConstruccionGav" class="tab-pane fade in active">
                    <br>
                    <h3>Cuenta con construcción de:</h3>
                    <br>
                    <input type="checkbox" name="CGavetaOc" value="#">Gavetas ocultas <br><br>
                    
                    <input type="checkbox" name="GavetaMtr" value="#">Gavetas a más de un metro <br><br>
                    
                    <input type="checkbox" name="Capilla" value="#">Capilla <br><br>
                    
                    <input type="checkbox" name="CapillaM" value="#">Media capilla <br><br>                
                    
                    <input type="checkbox" name="Nicho" value="#">Nicho <br><br>
                    
                    <input type="submit" value="Guardar">
                    
                </form>
                
                <form method="post" action="index.html" id="ConstruccionCap" class="tab-pane fade">
                    <br>
                    <h3>Tiene colocación de:</h3>
                    <br> 
                    <input type="checkbox" name="Tejaban" value="#">Tejaban <br><br>
                    
                    <input type="checkbox" name="Granito" value="#">Granito <br><br>
                                      
                    <input type="checkbox" name="Vitropiso" value="#">Vitropiso <br><br>
                    
                    <input type="checkbox" name="Marmol" value="#">Marmol <br><br>
                    
                    <input type="checkbox" name="Adornos" value="#">Adornos <br><br>
